...
namespace Daany.Util
{
    ...
    public class ConsoleTable
    {
        ...
        public void Write(Format format = Daany.Util.Format.Default)
        {
            switch (format)
            {
                case Daany.Util.Format.Default:
                    Options.OutputTo.WriteLine(ToString());
                    break;
                case Daany.Util.Format.MarkDown:
                    Options.OutputTo.WriteLine(ToMarkDownString());
                    break;
                case Daany.Util.Format.Alternative:
                    Options.OutputTo.WriteLine(ToStringAlternative());
                    break;
                case Daany.Util.Format.Minimal:
