    ...
    public sealed class SingularValueDecomposition //: ICloneable, ISolverMatrixDecomposition<Double>
    {
        ...
        public Double[,] DiagonalMatrix
        {
            get
            {
                ...
                return diagonalMatrix = MatrixEx.Diagonal(u.Columns(), v.Columns(), s);
            }
        }
